...
El sistema SHALL exponer un listado de todas las facturas mostrando, para cada una, su cliente, monto, fecha de vencimiento, saldo, estado de cobro y condición de vencimiento.
